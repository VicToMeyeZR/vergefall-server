...
**Ubuntu VPS at server1.trystarbot.space:** follow **[SETUP.md](SETUP.md)** (`docker-compose.yml` + Caddy on 443).
...
- UE5 gRPC is **7349** (published). Console 7351 is localhost-only.
